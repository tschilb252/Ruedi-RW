...
if __name__ == '__main__':
    inpath = r'C:\\Users\JLanini\\OneDrive - DOI\\Documents\\GitHub\\Ruedi-RW\Data\\Accounting Spreadsheets\\'
    outpath = r'C:\\Users\\JLanini\\OneDrive - DOI\\Documents\\GitHub\\Ruedi-RW\Data\\'
    ...
    for f in get_file_names(inpath):
        for sheet in sheetnames:
            ...
            if sheet == 'Contract Usage':
                ...
                dfcontracts = pd.concat([dfcontracts,df],axis=1)
                df=pd.DataFrame()
            else:
                skip = [0,1,2,8,9]
                ...
                df=pd.DataFrame()
    dfall = dfall.drop(index='00:00:00')
    ...
    dfall=(dfall.reindex(new_date_range))
